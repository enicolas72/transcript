...
for ARCH in "${ARCHES[@]}"; do
    ...
    CONFIG_ARGS=(
        ...
        "--disable-asm"
        "--enable-swresample"
        "--enable-demuxer=matroska,ogg,mov,mp3,wav,flac,aac,aiff,mp4,avi,asf,caf"
        "--enable-decoder=opus,vorbis,mp3,mp3float,aac,flac,alac,ac3,eac3,wmav1,wmav2,wmavoice,wmapro,pcm_s16le,pcm_s16be,pcm_s24le,pcm_s32le,pcm_f32le,pcm_alaw,pcm_mulaw"
